...
public class XMLParser {
    ...
    *           if no error is there, it calls and returns function printSQLCommands*/
    private boolean validateXML(String xml, ArrayList<Map> fieldsAttribs, String outputFileName) {
        ...
        return this.printSQLCommands(fieldValues, fieldsAttribs, tableName, outputFileName);
    }//end of validateXML
    ...
    *           If no error, it finds the file, or create one, and writes, or appends, those queries in it.*/
    private boolean printSQLCommands(ArrayList<Map> fieldValues, ArrayList<Map> fieldAttribs, String tableName,
                                  String fileName){
        ...
        if(SQLParser.currentDB != null ){
            ...
            System.out.println("***Error- no database is loaded currently. Please load a database first.");
            return false;
        }
        return true;
